...
<div id="register_mod" class="modal login_modal register_user">
 ...
 <div id="recover_mod" class="modal login_modal">
  ...
  <div class="send_pin"> <a class="btn blue mobi_search">Search</a> </div>
  </form>
  </div>
  </div>
  ...
  <section id="cars-section" class="update-vehicle-cars animated">
      ...
      <div class="row">
          <label id="up_car_type_error" class="car-type_label">Type of car*</label>
          <select id="car-type_update" name="car-type" class="browser-default">
              <option value="<?php echo @$ad_datail->car_type;?>" selected>
                  <?php echo @$ad_datail->car_type;?>
              </option>
              <option value="2 door">2 door</option>
              <option value="4 door">4 door</option>
              <option value="Convertible">Convertible</option>
      ...
      <div class="row">
          <div class="input-field">
              <input value="<?php echo @$ad_datail->miles;?>" id="millage_update" type="text" data-length="12">
              <label for="millage">Millage*</label>
          </div>
          <label id="up_millage_error" class="errors-3"></label>
      </div>
      <div class="continue"> <a id="carsUpdate_cont" class="cars_btn btn blue">continue</a> </div>
  </section>
  <section id="jobs-and-services-section" class="update-jobs-services animated">
      <div class="row company_employer_div_wrapper">
          <div class="input-field">
              <input id="up_employer" value="<?php echo @$ad_datail->company_employer;?>"  type="text" data-length="50">
              <label for="up_employer">Company / Employer*</label>
          </div>
          <div class="input-field deadline_wrapper">
              <input id="up_job_expiry_date" type="text" value="<?php echo @$ad_datail->appli_deadline;?>" class="datepicker">
              <label for="up_job_expiry_date">Application deadline(optional)</label>
          </div>
      </div>
      <div class="row">
          <label id="job_type_error" class="make_label">Job type*</label>
          <select class="browser-default" id="up_job_type">
              <option value="<?php echo @$ad_datail->job_type;?>" selected><?php echo @$ad_datail->job_type;?></option>
              <option value="Full Time">Full Time</option>
              <option value="Part Time">Part Time</option>
              <option value="Contract">Contract</option>
              <option value="Internship">Internship</option>
      ...
      <div class="row">
          <label id="qualification_error" class="model_label">Minimum qualification*</label>
          <select class="browser-default" id="up_qualification">
              <option value="<?php echo @$ad_datail->min_qualific;?>" selected><?php echo @$ad_datail->min_qualific;?></option>
              <option value="Ordinary Level">Ordinary Level</option>
              <option value="Advanced Level">Advanced Level</option>
              <option value="Higher National Diploma">Higher National Diploma</option>
              <option value="WASSCE / SHS">WASSCE / SHS</option>
      ...
      <div class="row">
          <label id="min_experience_error" class="">Minimum experience (years)*</label>
           <select id="up_min_experience" class="browser-default">
            <option value="<?php echo @$ad_datail->min_exp;?>" selected><?php echo @$ad_datail->max_exp;?></option>
            <option value="0">0</option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
      ...
      <div class="row">
          <label id="max_experience_error" class="max_experience_label">Maximum experience (years)*</label>
          <select id="up_max_experience" class="browser-default">
              <option value="<?php echo @$ad_datail->max_exp;?>" selected><?php echo @$ad_datail->max_exp;?></option>
              <option value="0">0</option>
              <option value="1">1</option>
              <option value="2">2</option>
              <option value="3">3</option>
      ...
      <div class="row">
          <div class="input-field col s12 m6 l6">
              <input id="up_salary_from" placeholder="GHS" min="0" type="text" value="<?php echo @$ad_datail->salary_from;?>" data-length="10">
              <label for="salary_from">Salary From*</label>
          </div>
          <div class="input-field col s12 m6 l6">
              <input id="up_salary_to" type="text" min="0" placeholder="GHS" value="<?php echo @$ad_datail->salary_to;?>"  data-length="10">
              <label for="salary_to">Salary To*</label>
          </div>
      </div>
      <div class="continue"> <a id="updat_jobs_continue" class="jobs_btn btn blue">continue</a> </div>
  </section>
  <section id="properties-section" class="update-property animated">
      <div class="row company_employer_div_wrapper">
          <div class="input-field">
              <input id="up_surface_size" type="number" min="0"  value="<?php echo @$ad_datail->surface_size;?>" data-length="20">
              <label for="surface_size">Surface siz (m2)*</label>
          </div>
      </div>
      <div class="row select-label-div">
          <label class="">Bedrooms *</label>
          <br/>
          <select class="browser-default" id="up_bedrooms">
              <option value="<?php echo @$ad_datail->bedrooms;?>" selected><?php echo @$ad_datail->bedrooms;?></option>
              <option value="1">1</option>
              <option value="2">2</option>
              <option value="3">3</option>
              <option value="4">4</option>
      ...
      <div class="row select-label-div">
          <label class="">Bathrooms *</label>
          <br/>
          <select class="browser-default" id="up_bathrooms">
              <option value="<?php echo @$ad_datail->bathrooms;?>" selected><?php echo @$ad_datail->bathrooms;?></option>
              <option value="1">1</option>
              <option value="2">2</option>
              <option value="3">3</option>
              <option value="4">4</option>
      ...
      <div class="row select-label-div">
          <label class="">Is there a broker fee? *</label>
          <select class="browser-default" id="up_broker_fee">
              <option value="<?php echo @$ad_datail->broker_fee;?>" selected><?php echo @$ad_datail->broker_fee;?></option>
              <option value="Yes">Yes</option>
              <option value="No">No</option>
          </select>
      </div>
      <br/>
    <div class="continue"> <a id="upda_property_btn" class="upda_property_btn btn blue">continue</a> </div>
  </section>
  <section class="update-vehicle-motocycles animated">
      <div class="row">
          <label style="margin-bottom:20px;">Motorcycle Make*</label>
          <select id="up_motorcycle-make" class="browser-default">
              <option selected>
                  <?php echo @$ad_datail->moto_make;?>
              </option>
              <option>Aprilia</option>
              <option>Benzhou</option>
              <option>BMW</option>
          ...
          <label id="up_moto_error" class="errors-3"></label>
      </div>
      <div class="row">
          <div class="continue"> <a id="moto_continue" class="Up_moto_btn btn blue">continue</a> </div>
      </div>
  </section>
  <section class="update-final-step animated">
      <div class="row wishlist-holder">
          <div class="input-field col l12 s12 m12 ">
              <input value="<?php echo @$ad_datail->wishes;?>" id="up_wishlist" placeholder="Iphone 7, Tv, Ladies Wear, Movies, Books etc." type="text" data-length="25">
              <label for="wishlist">Wishlist *</label>
          </div>
          ...
          <div class="input-field col l12 s12 m12">
              <select id="up_item-condition" class="browser-default">
                  <option value="<?php echo @$ad_datail->item_condit;?>" selected>
                      <?php echo @$ad_datail->item_condit;?>
                  </option>
                  <option value="New">New</option>
                  <option value="Used">Used</option>
              </select>
          </div>
          <label id="up_item_cond-error" class="errors-4"></label>
      </div>
      <div class="row">
          <div class="input-field col l12 s12 m12">
              <textarea id="up_description" class="materialize-textarea" maxlength="500" data-length="500">
                  <?php echo @$ad_datail->description;?>
              </textarea>
              <label for="up_description">Description*</label>
          </div>
          <label id="up_descrip_error" class="errors-4"></label>
      </div>
      <div class="row">
          <div class="input-field col l7 s7 m7">
              <input id="up_price" value="<?php echo @$ad_datail->value;?>" type="text" data-length="9">
              <label id="for-price" for="price">Price*</label>
          </div>
          <div class="input-field col l5 s5 m5">
              <p>
                  <input type="checkbox" id="up_negotiation" checked="checked" />
                  <label for="negotiation">Negotiable</label>
              </p>
          </div>
          <label id="up_price_error" class="errors-4"></label>
      </div>
      <div class="row">
          <div class="input-field col l12 s12 m12">
              <input id="up_poster-name" value="<?php echo @$ad_datail->poster_name;?>" type="text" data-length="24">
              <label for="input_text">Name*</label>
          </div>
          <label id="up_name_error" class="errors-4"></label>
      </div>
      <div class="row">
          <div class="input-field col l12 s12 m12">
              <input id="up_poster-mobile" value="<?php echo @$ad_datail->poster_mobile;?>" type="number" data-length="10">
              <label for="mobile">Mobile*</label>
          </div>
          <label id="up_mobile-error" class="errors-4"></label>
      </div>
      <div class="col xl12 s12 m12 submit"> <a class="add_more btn blue update_ad-btn"><i id="update-ad_spinner" class="fa" aria-hidden="true"></i><span style="margin-left:10px;" id="update_btn-txt">Save upadate</span></a> </div>
  </section>
  </div>
  </div>
